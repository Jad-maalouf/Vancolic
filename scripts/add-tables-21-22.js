// One-time migration (August 2026): brings the floor to 22 tables.
// Tables 21-22 are created if missing, or re-activated if they were
// deactivated; tables 1-20 are left as they are.
// Run with: node scripts/add-tables-21-22.js  (safe to re-run)
