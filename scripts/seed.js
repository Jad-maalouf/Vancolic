...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      ['Gin Basil Smash', 5, null, true, 'Gin, basil, sugar syrup, lime juice'],
      ['Passion Fruit Martini', 6, null, true, 'Vodka, passion fruit purée, sugar syrup, lime juice'],
      ...
      ['Blue Ice Tea', 6, null, true, 'Vodka, blue curacao, apple juice, XXL energy drink'],
      ...
      ['Godfather', 6, null, true, 'Whiskey, amaretto, rosemary'],
      ['Cuba Libre', 5, null, true, 'Rum, pepsi, lime juice'],
      ['Negroni', 5, null, true, 'Gin, campari, sweet vermouth, lemon zest'],
    ],
  },
  {
    category: 'cocktails',
    ...
    items: [
      ...
      ['Whiskey sour', 6, null, true, 'Bourbon whiskey, lime juice, sugar syrup, aromatic bitters'],
      ['Amaretto sour', 6, null, true, 'Amaretto, sugar syrup, lime juice, aromatic bitters'],
      ['Gin sour', 5, null, true, 'Gin, sugar syrup, lime juice, aromatic bitters'],
    ],
  },
  {
